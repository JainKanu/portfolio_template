  ...
  <v-container grid-list-xl>
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <form method="POST" action="https://formspree.io/f/xzbogpjr">
          <v-text-field
            name="name"
            color="green"
...
export default {
  metaInfo: {
    ...
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        name: 'description',
        content:
          "Karan Jain's Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe"
      },
      { charset: 'utf-8' },
  ...
  computed: {
    disableSubmitButton () {
      if (
        (this.nameErrors && this.nameErrors.length) ||
        (this.emailErrors && this.emailErrors.length) ||
        (this.bodyErrors && this.bodyErrors.length)
      ) {
        return true
      } else {
        return false
